	...
	homeBlinds: {
		...
		reveal: {
			...
			hero: {
				...
				badge: homeHero.bilibiliBadgeText ?? "B站：伊卡洛斯コ",
				bio: heroBioText,
				...
				speechChinese: homeHero.speechChinese ?? "B站：伊卡洛斯コ？",
				speechEnglish:
		...
		scenes: {
			...
			composite: {
				...
				title: "名字被写下之前",
				description: "笔尖悬停在纸面上方，一个名字，决定一段故事的走向。",
				alt: "夜色中摊开的笔记本与悬停笔尖合成的首幕画面",
			},
			items: [
				{
					eyebrow: "SCENE 02 / LIGHT",
					title: "光的背面",
					description: "正义与罪只隔一笔之距，名字落定之前，没有人知道答案。",
				...
				},
				{
					...
					title: "风翻过的那一页",
					description: "每一页都写满名字，风经过时，总有一个名字悄悄消失。",
				...
				},
				{
					...
					title: "纸上审判",
					description: "规则写在第一页：被写下名字的人，将在这里退场。",
				...
				},
				{
					...
					title: "新世界的黎明",
					description: "最后一页合上之前，下一章由谁执笔，还没有答案。。",
					image: "/assets/images/home-blinds/act3/4.webp",
					alt: "第五幕插画：合上的笔记与黎明前的天光",
				},
			],
